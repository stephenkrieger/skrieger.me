...
function updateSubtitle() {
  ...
  const location = getLocation();
  const radius = getRadius();
  subtitle.textContent = `Currently viewing all shows within ${radius} miles of ${location.name}. Use the menu to add/remove artists, change locations, or change distance.`;
}
